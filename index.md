...
3. **ARR commitment.** Submissions with already existing ACL Rolling Review (ARR) reviews, committed via [OpenReview](https://openreview.net/group?id=EMNLP/2026/Workshop/UncertaiNLP_ARR_Commitment) by the corresponding deadline in [Important Dates](#important-dates) above. These submissions must have been reviewed by ARR before; the ARR reviews will be used in our evaluation and must be linked to our system through the **paper link** field available in the OpenReview form. This route is also open to papers already accepted to EMNLP 2026 (main conference or Findings): if your work fits the topics above, we warmly invite you to commit your ARR reviews and present it at the workshop as well — our goal is to gather the community working on uncertainty quantification in one place. Note that only ARR reviews can be committed: reviews from the EMNLP 2026 industry track are not accepted, so if your paper was reviewed there, please submit it directly via the regular submission form as a non-archival submission instead.
...
- Julian Rodemann (CISPA Helmholtz Center for Information Security, DE)
...
- Samuel Barry (Stanford University, US)
...
- Humayun Akhtar (Prime Robotics, US)
- Zihao Zheng (PDD Holdings, CN)
- Plawan Kumar Rath (Meta, US)
- Siming Zhao (Google, US)
- Krishna Aswani (Amazon, US)
